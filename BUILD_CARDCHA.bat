...
title Cardcha! v0.1.17-alpha.11.6 Auto Build + Install
cd /d "%~dp0"

set "ROOT=%~dp0"
set "EXPECTED_BUILD=Cardcha! v0.1.17-alpha.11.6 MIMI MERCHANT + SCRAP WALLET + WIZARD SCALE + CHACHA SIZE"
...
cls
echo ============================================================
echo   CARDCHA! v0.1.17-alpha.11.6 - AUTO BUILD + AUTO INSTALL
echo ============================================================
echo.
echo Game:
echo %GAME_PATH%
...
echo [Cardcha!] Cardcha! v0.1.17-alpha.11.6 MIMI MERCHANT + SCRAP WALLET + WIZARD SCALE + CHACHA SIZE + HANDOFF ACTIVE...
echo.
