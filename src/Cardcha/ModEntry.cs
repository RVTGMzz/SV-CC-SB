...
internal sealed class ModEntry : Mod
{
    ...
    private void OnGameLaunched(object? sender, GameLaunchedEventArgs e)
    {
        ...
        this.Monitor.Log(
            $"Cardcha! v0.3.0-alpha.27.0.7.7.4 ATTIC ACCEPTANCE POLISH TEST with {this.Cards.All.Count} cards. The cardboard is now combat-capable. This seems unsafe.",
            LogLevel.Info
        );
    }
    ...
    {
        this.Monitor.Log(
            "Cardcha! v0.3.0-alpha.27.0.7.7.4 ATTIC ACCEPTANCE POLISH TEST",
            LogLevel.Alert
        );
    }
