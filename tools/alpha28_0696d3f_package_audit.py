...
def main() -> None:
    ...
    with zipfile.ZipFile(args.package) as z:
        ...
        checks["transparentConsoleRuntimeAssetsPresent"] = all(
            path in names
            for path in (
                "Cardcha/assets/airship_props/set01_redux/console_runtime/navigation_console_frame.png",
    ...
    report = {
        ...
        "runtimeNote": "Package audit proves distributable structure only. D3-F physical blocking/depth/travel acceptance remains an in-game retest.",
    }
